export declare const MESSAGES: {
    ...
    UPGRADE_GLOBAL_CLI_HINT: string;
    OBSERVABILITY_QUESTION: string;
    MAU_INSTALLATION_QUESTION: (name: string) => string;
    MAU_INSTALLATION_IN_PROGRESS: (name: string) => string;
    MAU_INSTALLATION_DECLINED: (name: string, command: string) => string;
    MAU_INSTALLATION_FAILED: (name: string) => string;
    MAU_NOT_INSTALLED_NON_INTERACTIVE: (name: string, command: string) => string;
};
