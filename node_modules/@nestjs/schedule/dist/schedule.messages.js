export const NO_SCHEDULER_FOUND = (schedulerName, name) => name
...
export const DUPLICATE_SCHEDULER = (schedulerName, name) => `${schedulerName} with the given name (${name}) already exists. Ignored.`;
